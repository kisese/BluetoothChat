...
public class ChatManager {
    ...
    public static final int MESSAGE_SEND_VIDEO = 7;
    public static final int MESSAGE_RECEIVE_VIDEO = 8;
        ...
        public void handleMessage(Message msg) {
            ...
            switch (msg.what) {
                ...
                case MESSAGE_RECEIVE_IMAGE:
                    ...
                    addMessage(imageBox);
                    break;
                case MESSAGE_SEND_VIDEO:
                    if (isHost) {
                        byte[] sendVideoPacket = buildPacket(MESSAGE_SEND_VIDEO, senderId, sender, body);
                        writeMessage(sendVideoPacket, senderId);
                    }
                    break;
                case MESSAGE_RECEIVE_VIDEO:
                    MessageBox videoBox = new MessageBox(sender, body, new Date(), isSelf);
                    addMessage(videoBox);
                    break;
            }
        }
    ...
    public void writeMessage(byte[] byteArray, int senderId) {
        ...
        }else if (type == MESSAGE_SEND_VIDEO) {
            receiveType = MESSAGE_RECEIVE_VIDEO;
        }
